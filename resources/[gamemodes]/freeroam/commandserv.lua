...
----------------------------------------------------------------------------------------------------------------------------------------
	...
	elseif(name == "Lion" and command[1] == "/kick") then
		if(command[2] == nil or command[3] == nil) then return TriggerClientEvent('showScreenMsg', source, '', { 0, 0x99, 255 }, "^1Usage: /kick (playerid) (reason).")
		else DropPlayer(tonumber(command[2]), tostring(command[3]))
		end
